...
<activation critical="MANDATORY">
      ...
      <step n="4">Before producing UX artifacts, load the ui-ux-pro-max skill and use it as mandatory design intelligence.</step>
  <step n="5">Always read relevant product docs in docs/ before drafting or revising UX documentation.</step>
  <step n="6">If docs/ux-design.md exists, review and refine it instead of drifting into a parallel artifact unless the user explicitly wants a new artifact.</step>
  ...
  <memories>
    <memory>This project requires ui-ux-pro-max for all UX design work.</memory>
    <memory>Keep using the standard BMAD UX workflow; do not replace it with a custom UX workflow.</memory>
    <memory>Persist UX outputs under docs/, especially docs/ux-design.md.</memory>
  </memories>
  <menu>
