...
def main():
    ...
    copy_file(
        pkg / 'extras/opencode-commands/bmad-create-data-architecture.md',
        repo / '.opencode/commands/bmad-create-data-architecture.md'
    )

    skill_dir = repo / '.opencode/skills/bmad-create-data-architecture'
    skill_dir.mkdir(parents=True, exist_ok=True)
    copy_file(
        pkg / 'src/workflows/bmad-create-data-architecture/workflow.md',
        skill_dir / 'SKILL.md'
    )
