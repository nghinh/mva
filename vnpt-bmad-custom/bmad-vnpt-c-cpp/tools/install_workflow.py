...
def main() -> None:
    ...
    copy_file(
        pkg / "extras/opencode-commands/bmad-vnpt-c-cpp.md",
        repo / ".opencode/commands/bmad-vnpt-c-cpp.md",
    )
    copy_tree(
        pkg / "extras/opencode-skills/bmad-vnpt-c-cpp",
        repo / ".opencode/skills/bmad-vnpt-c-cpp",
    )
    copy_file(
        pkg / "src/workflows/bmad-vnpt-c-cpp/workflow.md",
