...
- the local bundled Spring Boot skill pack in `.opencode/skills/bmad-vnpt-java-springboot-custom/`

## Mandatory Rules
- Always load and use `bmad-vnpt-java-springboot-custom` before producing significant Java/Spring Boot backend changes.
