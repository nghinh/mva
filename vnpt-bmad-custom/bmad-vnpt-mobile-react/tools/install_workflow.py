...
def main() -> None:
    ...
    copy_file(
        pkg / "extras/opencode-commands/bmad-vnpt-mobile-react.md",
        repo / ".opencode/commands/bmad-vnpt-mobile-react.md",
    )
    copy_tree(
        pkg / "extras/opencode-skills/bmad-vnpt-mobile-react",
        repo / ".opencode/skills/bmad-vnpt-mobile-react",
    )
    copy_file(
        pkg / "src/workflows/bmad-vnpt-mobile-react/workflow.md",
