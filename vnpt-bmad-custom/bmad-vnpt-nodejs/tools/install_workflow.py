...
def main() -> None:
    ...
    copy_file(
        pkg / 'extras/opencode-commands/bmad-vnpt-nodejs.md',
        repo / '.opencode/commands/bmad-vnpt-nodejs.md',
    )
    copy_tree(
        pkg / 'extras/opencode-skills/bmad-vnpt-nodejs',
        repo / '.opencode/skills/bmad-vnpt-nodejs',
    )
    copy_file(
        pkg / 'src/workflows/bmad-vnpt-nodejs/workflow.md',
